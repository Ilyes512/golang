...
DOCKER_ARG_VERSION="GOLANGCI_LINT_VERSION"
DOCKER_ARG_CHECKSUM="GOLANGCI_LINT_SHA256"
...
CHECKSUM_FILE_NAME="${NAME}-${LATEST_VERSION#"v"}-checksums.txt"
FILE_NAME="${NAME}-${LATEST_VERSION#"v"}-linux-amd64.deb"
